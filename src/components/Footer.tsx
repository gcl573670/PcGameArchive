    ...
    <footer className="border-t border-border bg-secondary/30 mt-20">
      <div className="container mx-auto max-w-7xl px-4 py-12">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <h3 className="mb-3 text-sm font-bold text-foreground">{t.footer.categories}</h3>
          ...
          <div>
            <h3 className="mb-3 text-sm font-bold text-foreground">{t.footer.legal}</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link to={`${langPrefix}/privacy`} className="hover:text-primary transition-colors">{t.footer.privacy}</Link></li>
              <li><Link to={`${langPrefix}/terms`} className="hover:text-primary transition-colors">{t.footer.terms}</Link></li>
              <li><Link to={`${langPrefix}/about`} className="hover:text-primary transition-colors">{t.footer.about}</Link></li>
        ...
        <div className="mt-8 border-t border-border pt-6 text-center">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} pcgamearchive.com. {t.footer.rights}
          </p>
        </div>
      </div>
    </footer>
