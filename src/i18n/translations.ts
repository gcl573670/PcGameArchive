...
const en: TranslationKeys = {
  ...
  footer: { categories: "Categories", legal: "Legal", company: "Company", privacy: "Privacy Policy", terms: "Terms & Conditions", about: "About Us", contact: "Contact Us", rights: "All rights reserved.", description: "Free PC game downloads. Action, Adventure, Horror, Indie, and more." },
};
...
export const translations: Record<Language, TranslationKeys> = {
  ...
  es: {
    ...
    footer: { categories: "Categorías", legal: "Legal", company: "Empresa", privacy: "Privacidad", terms: "Términos", about: "Sobre nosotros", contact: "Contacto", rights: "Todos los derechos reservados.", description: "Descargas de juegos de PC gratis." },
  },
  de: {
    ...
    footer: { categories: "Kategorien", legal: "Rechtliches", company: "Unternehmen", privacy: "Datenschutz", terms: "AGB", about: "Über uns", contact: "Kontakt", rights: "Alle Rechte vorbehalten.", description: "Kostenlose PC-Spiele-Downloads." },
  },
  fr: {
    ...
    footer: { categories: "Catégories", legal: "Mentions légales", company: "Entreprise", privacy: "Confidentialité", terms: "CGU", about: "À propos", contact: "Contact", rights: "Tous droits réservés.", description: "Téléchargements de jeux PC gratuits." },
  },
  pt: {
    ...
    footer: { categories: "Categorias", legal: "Legal", company: "Empresa", privacy: "Privacidade", terms: "Termos", about: "Sobre nós", contact: "Contato", rights: "Todos os direitos reservados.", description: "Downloads de jogos de PC grátis." },
  },
  it: {
    ...
    footer: { categories: "Categorie", legal: "Legale", company: "Azienda", privacy: "Privacy", terms: "Termini", about: "Chi siamo", contact: "Contattaci", rights: "Tutti i diritti riservati.", description: "Download di giochi PC gratuiti." },
  },
  nl: {
    ...
    footer: { categories: "Categorieën", legal: "Juridisch", company: "Bedrijf", privacy: "Privacy", terms: "Voorwaarden", about: "Over ons", contact: "Contact", rights: "Alle rechten voorbehouden.", description: "Gratis PC game downloads." },
  },
  pl: {
    ...
    footer: { categories: "Kategorie", legal: "Prawne", company: "Firma", privacy: "Prywatność", terms: "Regulamin", about: "O nas", contact: "Kontakt", rights: "Wszelkie prawa zastrzeżone.", description: "Darmowe pobieranie gier PC." },
  },
  sv: {
    ...
    footer: { categories: "Kategorier", legal: "Juridiskt", company: "Företag", privacy: "Integritet", terms: "Villkor", about: "Om oss", contact: "Kontakt", rights: "Alla rättigheter förbehållna.", description: "Gratis PC-spel nedladdningar." },
  },
  no: {
    ...
    footer: { categories: "Kategorier", legal: "Juridisk", company: "Selskap", privacy: "Personvern", terms: "Vilkår", about: "Om oss", contact: "Kontakt", rights: "Alle rettigheter reservert.", description: "Gratis PC-spill nedlastinger." },
  },
  ru: {
    ...
    footer: { categories: "Категории", legal: "Правовая информация", company: "Компания", privacy: "Конфиденциальность", terms: "Условия", about: "О нас", contact: "Контакты", rights: "Все права защищены.", description: "Бесплатные загрузки игр для ПК." },
  },
  tr: {
    ...
    footer: { categories: "Kategoriler", legal: "Yasal", company: "Şirket", privacy: "Gizlilik", terms: "Şartlar", about: "Hakkımızda", contact: "İletişim", rights: "Tüm hakları saklıdır.", description: "Ücretsiz PC oyun indirmeleri." },
  },
  ar: {
    ...
    footer: { categories: "الفئات", legal: "قانوني", company: "الشركة", privacy: "الخصوصية", terms: "الشروط", about: "من نحن", contact: "اتصل بنا", rights: "جميع الحقوق محفوظة.", description: "تحميل ألعاب PC مجانية." },
  },
  id: {
    ...
    footer: { categories: "Kategori", legal: "Hukum", company: "Perusahaan", privacy: "Privasi", terms: "Ketentuan", about: "Tentang kami", contact: "Hubungi kami", rights: "Hak cipta dilindungi.", description: "Unduh game PC gratis." },
  },
  vi: {
    ...
    footer: { categories: "Danh mục", legal: "Pháp lý", company: "Công ty", privacy: "Quyền riêng tư", terms: "Điều khoản", about: "Về chúng tôi", contact: "Liên hệ", rights: "Bảo lưu mọi quyền.", description: "Tải game PC miễn phí." },
  },
  th: {
    ...
    footer: { categories: "หมวดหมู่", legal: "กฎหมาย", company: "บริษัท", privacy: "ความเป็นส่วนตัว", terms: "ข้อกำหนด", about: "เกี่ยวกับเรา", contact: "ติดต่อเรา", rights: "สงวนลิขสิทธิ์", description: "ดาวน์โหลดเกม PC ฟรี" },
  },
  ko: {
    ...
    footer: { categories: "카테고리", legal: "법적 고지", company: "회사", privacy: "개인정보", terms: "이용약관", about: "소개", contact: "문의", rights: "모든 권리 보유.", description: "무료 PC 게임 다운로드." },
  },
  ja: {
    ...
    footer: { categories: "カテゴリ", legal: "法的情報", company: "会社", privacy: "プライバシー", terms: "利用規約", about: "会社概要", contact: "お問い合わせ", rights: "全著作権所有。", description: "無料PCゲームダウンロード。" },
  },
  hi: {
    ...
    footer: { categories: "श्रेणियां", legal: "कानूनी", company: "कंपनी", privacy: "गोपनीयता", terms: "शर्तें", about: "हमारे बारे में", contact: "संपर्क करें", rights: "सर्वाधिकार सुरक्षित।", description: "मुफ्त PC गेम डाउनलोड।" },
  },
  bn: {
    ...
    footer: { categories: "বিভাগ", legal: "আইনি", company: "কোম্পানি", privacy: "গোপনীয়তা", terms: "শর্তাবলী", about: "আমাদের সম্পর্কে", contact: "যোগাযোগ", rights: "সর্বস্বত্ব সংরক্ষিত।", description: "বিনামূল্যে PC গেম ডাউনলোড।" },
  },
  ro: {
    ...
    footer: { categories: "Categorii", legal: "Legal", company: "Companie", privacy: "Confidențialitate", terms: "Termeni", about: "Despre noi", contact: "Contact", rights: "Toate drepturile rezervate.", description: "Descărcări gratuite de jocuri PC." },
  },
  cs: {
    ...
    footer: { categories: "Kategorie", legal: "Právní", company: "Společnost", privacy: "Soukromí", terms: "Podmínky", about: "O nás", contact: "Kontakt", rights: "Všechna práva vyhrazena.", description: "Stahování PC her zdarma." },
  },
  hu: {
    ...
    footer: { categories: "Kategóriák", legal: "Jogi", company: "Cég", privacy: "Adatvédelem", terms: "Feltételek", about: "Rólunk", contact: "Kapcsolat", rights: "Minden jog fenntartva.", description: "Ingyenes PC játék letöltések." },
  },
  el: {
    ...
    footer: { categories: "Κατηγορίες", legal: "Νομικά", company: "Εταιρεία", privacy: "Απόρρητο", terms: "Όροι", about: "Σχετικά", contact: "Επικοινωνία", rights: "Με επιφύλαξη παντός δικαιώματος.", description: "Δωρεάν λήψεις PC παιχνιδιών." },
  },
  da: {
    ...
    footer: { categories: "Kategorier", legal: "Juridisk", company: "Virksomhed", privacy: "Privatliv", terms: "Vilkår", about: "Om os", contact: "Kontakt", rights: "Alle rettigheder forbeholdes.", description: "Gratis PC-spil downloads." },
  },
  fi: {
    ...
    footer: { categories: "Kategoriat", legal: "Oikeudelliset", company: "Yritys", privacy: "Tietosuoja", terms: "Ehdot", about: "Meistä", contact: "Yhteystiedot", rights: "Kaikki oikeudet pidätetään.", description: "Ilmaisia PC-pelien latauksia." },
  },
  sk: {
    ...
    footer: { categories: "Kategórie", legal: "Právne", company: "Spoločnosť", privacy: "Súkromie", terms: "Podmienky", about: "O nás", contact: "Kontakt", rights: "Všetky práva vyhradené.", description: "Sťahovanie PC hier zadarmo." },
  },
  bg: {
    ...
    footer: { categories: "Категории", legal: "Правна информация", company: "Компания", privacy: "Поверителност", terms: "Условия", about: "За нас", contact: "Контакт", rights: "Всички права запазени.", description: "Безплатни PC игри за изтегляне." },
  },
  uk: {
    ...
    footer: { categories: "Категорії", legal: "Правова інформація", company: "Компанія", privacy: "Конфіденційність", terms: "Умови", about: "Про нас", contact: "Контакти", rights: "Усі права захищені.", description: "Безкоштовні завантаження ігор для ПК." },
  },
  sr: {
    ...
    footer: { categories: "Категорије", legal: "Правно", company: "Компанија", privacy: "Приватност", terms: "Услови", about: "О нама", contact: "Контакт", rights: "Сва права задржана.", description: "Бесплатне PC игре за преузимање." },
  },
  ms: {
    ...
    footer: { categories: "Kategori", legal: "Undang-undang", company: "Syarikat", privacy: "Privasi", terms: "Terma", about: "Tentang kami", contact: "Hubungi kami", rights: "Hak cipta terpelihara.", description: "Muat turun permainan PC percuma." },
  },
  fil: {
    ...
    footer: { categories: "Mga Kategorya", legal: "Legal", company: "Kompanya", privacy: "Privacy", terms: "Mga Tuntunin", about: "Tungkol sa amin", contact: "Makipag-ugnayan", rights: "Lahat ng karapatan ay nakalaan.", description: "Libreng PC game downloads." },
  },
  he: {
    ...
    footer: { categories: "קטגוריות", legal: "משפטי", company: "חברה", privacy: "פרטיות", terms: "תנאים", about: "אודות", contact: "צור קשר", rights: "כל הזכויות שמורות.", description: "הורדות משחקי PC בחינם." },
  },
  fa: {
    ...
    footer: { categories: "دسته‌بندی‌ها", legal: "حقوقی", company: "شرکت", privacy: "حریم خصوصی", terms: "شرایط", about: "درباره ما", contact: "تماس", rights: "تمامی حقوق محفوظ است.", description: "دانلود بازی‌های رایگان PC." },
  },
  hr: {
    ...
    footer: { categories: "Kategorije", legal: "Pravno", company: "Tvrtka", privacy: "Privatnost", terms: "Uvjeti", about: "O nama", contact: "Kontakt", rights: "Sva prava pridržana.", description: "Besplatne PC igre za preuzimanje." },
  },
};
